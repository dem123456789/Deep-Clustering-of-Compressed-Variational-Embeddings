...
class VADE(nn.Module):
    def __init__(self):
        ...
        self.param = nn.ParameterDict({
            'mu': nn.Parameter(torch.randn(config.PARAM['latent_size'], config.PARAM['classes_size'])),
            'var': nn.Parameter(torch.ones(config.PARAM['latent_size'], config.PARAM['classes_size'])),
