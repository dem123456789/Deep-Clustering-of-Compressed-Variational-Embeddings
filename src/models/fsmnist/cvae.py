...
class Encoder(nn.Module):
    ...
    def make_encoder_info(self):
        encoder_info = [
        {'input_size':3,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'fc','normalization':'none','activation':'tanh','raw':False},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},         
        {'input_size':512,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'pass','normalization':'none','activation':'tanh','raw':False},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},
        {'input_size':512,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'pass','normalization':'none','activation':'tanh','raw':False},
        {'cell':'ShuffleCell','mode':'down','scale_factor':2},
        {'input_size':512,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'pass','normalization':'none','activation':'tanh','raw':False},
...
class Decoder(nn.Module):
    ...
    def make_decoder_info(self):
        decoder_info = [
        {'input_size':128,'output_size':128,'num_layer':1,'cell':'BasicCell','mode':'fc','normalization':'none','activation':'tanh','raw':False},      
        {'input_size':128,'output_size':512,'num_layer':1,'cell':'BasicCell','mode':'pass','normalization':'none','activation':'tanh','raw':False},
