...
# 	y_hard = y_hard.view(-1,10*4,1,1)
# 	return y_hard

# def main():
# 	A = torch.rand(2,10,4) #10x4
# 	A_soft = gumbel_softmax(A,0.5,hard=False)
# 	A_hard = gumbel_softmax(A,0.5,hard=True)
# 	print(A_soft.view(-1,10,4),A_hard.view(-1,10,4))
